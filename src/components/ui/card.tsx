...
const CardTitle = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement> // Corrected from HTMLParagraphElement to HTMLDivElement to match usage
>(({ className, ...props }, ref) => (
  <div // Corrected from h3 to div to match usage and allow more flexibility
    ref={ref}
    className={cn(
